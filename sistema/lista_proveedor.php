...
<body>
  ...
  <section id="container">
    <h1><i class="fa-solid fa-clipboard-list"></i> Lista de Proveedores</h1>
    ...
    <table>
      ...
      // fin del codigo para el paginador
        ...
        $query = mysqli_query($conection,"SELECT * FROM proveedor WHERE estatus = 1
                              ORDER BY codproveedor ASC /*esta instruccion me ordena de forma acendente la lista */
      ...
      <tr>
        ...
        <td>
          ...
          |
          <a class="link_delete" href="eliminar_proveedor.php?id=<?php echo $data['codproveedor'] ?>"><i class="fa-solid fa-trash-can"></i> ELIMINAR</a>
        </td>
      </tr>
      <?php
          }
