...
<head>
	<meta charset="UTF-8">
	<title>Factura</title>
  <!-- Se agrega los estilos en el mismo arfivo ya que no reconoce el link para armar en formato PDF -->
<style type="text/css">
		...
		<tr>
			...
			<td class="info_empresa">
				...
				<div>
					...
					<p>RUT: <?php echo $configuracion['rut']; ?></p>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>Documento:</label><p><?php echo $factura['doc']; ?></p></td>
